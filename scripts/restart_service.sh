...
LOG_FILE="${LOG_DIR}/restart_service.log" # Absolute path to log file
SERVICE_NAME="quiz-topfinanzas-com"       # PM2 service name
...
# Step 6: Configure PM2 to start on system boot
